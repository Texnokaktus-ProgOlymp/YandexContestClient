...
namespace YandexContestClient.Client.Submissions.Item.Rejudge
{
    ...
    public partial class RejudgeRequestBuilder : BaseRequestBuilder
    {
        ...
        public RejudgeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/submissions/{submissionId}/rejudge", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::YandexContestClient.Client.Submissions.Item.Rejudge.RejudgeRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RejudgeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/submissions/{submissionId}/rejudge", rawUrl)
        {
        }
        /// <summary>
