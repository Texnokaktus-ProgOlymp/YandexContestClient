...
namespace Texnokaktus.ProgOlymp.YandexContestClient.Client.Contests.Item.Participants.Item.Stats
{
    ...
    public partial class StatsRequestBuilder : BaseRequestBuilder
    {
        ...
        public StatsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/contests/{contestId}/participants/{participantId}/stats", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Texnokaktus.ProgOlymp.YandexContestClient.Client.Contests.Item.Participants.Item.Stats.StatsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public StatsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/contests/{contestId}/participants/{participantId}/stats", rawUrl)
        {
        }
        /// <summary>
