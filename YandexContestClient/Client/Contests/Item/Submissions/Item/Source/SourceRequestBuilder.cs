...
namespace Texnokaktus.ProgOlymp.YandexContestClient.Client.Contests.Item.Submissions.Item.Source
{
    ...
    public partial class SourceRequestBuilder : BaseRequestBuilder
    {
        ...
        public SourceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/contests/{contestId}/submissions/{submissionId}/source", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Texnokaktus.ProgOlymp.YandexContestClient.Client.Contests.Item.Submissions.Item.Source.SourceRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SourceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/contests/{contestId}/submissions/{submissionId}/source", rawUrl)
        {
        }
        /// <summary>
