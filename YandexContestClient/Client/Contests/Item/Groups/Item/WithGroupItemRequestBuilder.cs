...
namespace YandexContestClient.Client.Contests.Item.Groups.Item
{
    ...
    public partial class WithGroupItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithGroupItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/contests/{contestId}/groups/{groupId}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::YandexContestClient.Client.Contests.Item.Groups.Item.WithGroupItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithGroupItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/contests/{contestId}/groups/{groupId}", rawUrl)
        {
        }
        /// <summary>
