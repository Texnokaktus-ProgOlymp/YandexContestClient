...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Texnokaktus.ProgOlymp.YandexContestClient.Client.Models.ProblemResult>? ProblemResults { get; set; }
#nullable restore
#else
        public List<global::Texnokaktus.ProgOlymp.YandexContestClient.Client.Models.ProblemResult> ProblemResults { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Texnokaktus.ProgOlymp.YandexContestClient.Client.Models.ContestStandingsRow"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Texnokaktus.ProgOlymp.YandexContestClient.Client.Models.ContestStandingsRow"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Texnokaktus.ProgOlymp.YandexContestClient.Client.Models.ContestStandingsRow CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Texnokaktus.ProgOlymp.YandexContestClient.Client.Models.ContestStandingsRow();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "problemResults", n => { ProblemResults = n.GetCollectionOfObjectValues<global::Texnokaktus.ProgOlymp.YandexContestClient.Client.Models.ProblemResult>(global::Texnokaktus.ProgOlymp.YandexContestClient.Client.Models.ProblemResult.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Texnokaktus.ProgOlymp.YandexContestClient.Client.Models.ProblemResult>("problemResults", ProblemResults);
